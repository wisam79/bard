...
const CartList: React.FC<CartListProps> = ({ cart, updateQty, removeFromCart }) => {
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar">
      {cart.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full text-brand-muted/40 space-y-4 py-20 animate-fade-in">
          ...
          <div className="text-center">
            <p className="text-sm font-black text-brand-muted/50 tracking-tight">السلة فارغة</p>
        ...
        cart.map((item: CartItem) => (
          <div
            ...
            className="bg-brand-surface/40 dark:bg-brand-dark/40 border border-brand-border/35 rounded-2xl p-4 group hover:border-primary-500/30 transition-all duration-150 shadow-sm animate-fade-in"
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[9px] font-bold text-brand-muted/50 uppercase tracking-wide">
              ...
              <button
                ...
                className="p-1.5 text-brand-muted/40 hover:text-rose-500 hover:bg-rose-500/10 rounded-lg transition-all"
              >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1 bg-brand-dark/25 p-0.5 rounded-lg border border-brand-border/25">
                <button
              ...
              <div className="text-left">
                <p className="text-[14px] font-black text-primary-500 flex items-baseline gap-1">
                  ...
                  <span className="text-[8px] font-bold text-brand-muted/40">د.ع</span>
                </p>
              </div>
            </div>
          </div>
